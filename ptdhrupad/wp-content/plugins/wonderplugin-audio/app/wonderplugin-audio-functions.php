...
function wonderplugin_audio_tags_allow( $allowedposttags ) {
	...
	$allowedposttags = apply_filters( 'wonderplugin_audio_custom_tags_allow', $allowedposttags );
...
function wonderplugin_audio_css_allow($allowed_attr) {
	...
	$allowed_attr = apply_filters( 'wonderplugin_audio_custom_css_allow', $allowed_attr );
...
function wonderplugin_audio_remove_url_arg( $url )
{
	return remove_query_arg(array('action', 'action2'), $url);
}