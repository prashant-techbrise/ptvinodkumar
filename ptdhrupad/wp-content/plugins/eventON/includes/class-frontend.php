				...
				if( (!empty($evo_opt['evosm_som']) && $evo_opt['evosm_som']=='yes' && $__calendar_type=='single') 
					...
					$social_sites = apply_filters('evo_se_social_media', array(
						...
						'Twitter'    => array(
							...
							'counter' =>1,
							'favicon' => 'twitter.png',
							'url' => '<a class="tw evo_ss" onclick="'.$tw_js.'" href="http://twitter.com/share?text=TITLECOUNT&#32;-&#32;&url=PERMALINK" title="'.evo_lang('Share on Twitter').'" rel="nofollow" target="_blank" data-url="PERMALINK"><i class="fa fa-twitter"></i></a>',
						),
						'LinkedIn'=> array(
							'key'=>'eventonsm_ln',
						...
						'Google' => Array (
							...
							'url' => '<a class="gp evo_ss" href="https://plus.google.com/share?url=PERMALINK" 
								onclick="'.$fb_js.'" target="_blank"><i class="fa fa-google-plus" title="'.evo_lang('Share on Google Plus').'"></i></a>'
						),
						'Pinterest' => Array (
							'key'=>'eventonsm_pn',
							'counter' =>1,
